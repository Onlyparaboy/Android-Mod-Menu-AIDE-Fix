...
Java_uk_lgl_modmenu_FloatingModMenuService_Title(JNIEnv *env, jobject thiz) {
    titleValid = true;
    return env->NewStringUTF("Modded by (yourname)");
}
...
Java_uk_lgl_modmenu_FloatingModMenuService_Heading(JNIEnv *env, jobject thiz) {
    headingValid = true;
    return env->NewStringUTF("Put your website or notes here");
}
...
Java_uk_lgl_modmenu_FloatingModMenuService_getFeatureList(JNIEnv *env, jobject activityObject) {
    ...
    const char *features[] = {
            "Category_The Category",
            "Toggle_The toggle",
            "SeekBar_The slider_4_100",
            "SeekBar_Kittymemory slider example_0_5",
            "Spinner_The spinner_Items 1,Items 2,Items 3",
            "Button_The button",
            "Button_OnOff_The On/Off button",
            "InputValue_The input number",
