...
Java_uk_lgl_modmenu_Preferences_Changes(JNIEnv *env, jclass clazz, jobject obj,
    ...
    LOGD("Feature name: %d - %s | Value: = %d | Bool: = %d", feature, featureName, value,
                       boolean);
...
void *hack_thread(void *) {
    ...
    LOGI("Lib %s has been loaded", libName);
    ...
    hexPatches.GodMode = MemoryPatch::createWithHex(libName,
                                                    string2Offset("0x123456"),
                                                    "00 00 A0 E3 1E FF 2F E1");

    // Offset Hook example
    A64HookFunction((void *) getAbsoluteAddress(libName, string2Offset("0x123456")), (void *) get_BoolExample,
